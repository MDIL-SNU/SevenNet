...
void set_atom_forces(MLIAPDataKokkosDevice*, double*);
void set_total_energy(MLIAPDataKokkosDevice*, double);
void add_global_virial(MLIAPDataKokkosDevice*, const double* v6);
void add_global_stress(MLIAPDataKokkosDevice*, const double *);
