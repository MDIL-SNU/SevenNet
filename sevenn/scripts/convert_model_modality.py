...
modal_module_dict = {
    KEY.USE_MODAL_NODE_EMBEDDING: 'onehot_to_feature',
    KEY.USE_MODAL_SELF_INTER_INTRO: 'self_interaction_1',
    KEY.USE_MODAL_SELF_INTER_OUTRO: 'self interaction 2',
    KEY.USE_MODAL_OUTPUT_BLOCK: 'reducing nn input',
}
...
# TODO: apply modality in tensor product module?
def _erase_FCTP_modal_params(
    model_state_dct,
    erase_modal_idx: int,
    key: str,
    irreps_in: str,
...
def get_single_modal_model_dct(
    ...
    num_modalities = config[KEY.NUM_MODALITIES + key_add]
    ...
    final_block_key = 'reducing nn hidden to energy'
