...
void CommBrick::forward_comm(PairE3GNNParallelCPU *pair)
{
  int iswap,n;
  MPI_Request request;
  ...
  if (nswap > 6) error->all(FLERR,"PairE3GNNParallelCPU: Cell size is too small. Please use a single GPU or make a supercell");
...
void CommBrick::reverse_comm(PairE3GNNParallelCPU *pair)
{
  int iswap,n;
  MPI_Request request;
