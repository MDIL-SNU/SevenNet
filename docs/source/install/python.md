...
- [Optional] cuEquivariance >= 0.6.1
- [Optional] flashTP >= 0.1.0
- [Optional] cuEquivariance, flashTP both require Python >= 3.10
...
```bash
sevenn input.yaml -s --enable_cueq # or --enable_flashTP
```
