...
## [0.10.0]
SevenNet now have CI workflows using pytest and its coverage is near 80%!
...
- log.sevenn and lc.csv automatically finds safe filename (log0.sevenn, log1.sevenn, ...) to avoid overwriting.
...
- ... and lots of small bugs I found during pytest.
